    ...
    def insert_data(self, table_name, data):
        ...
        insert_query = sql.SQL("""
            INSERT INTO {} (
                ...
                referer, device_category, operating_system_root, direct_platform,
                direct_condition_type, utm_campaign, utm_content, utm_medium,
                utm_source, utm_term, traffic_source, page_views, purchase_id,
